...
export const DOMAINS: Domain[] = [
  ...
  { name: "신체 기능", count: 14,
    lead: "몸을 움직이는 힘과 혼자 해내시는 정도를 나눠서 여쭤봅니다", cards: [
    c("mobility_diff_general", "평소 걷거나 몸을 움직일 때 불편함을 느끼십니까?", DIFF3,
      "보조기 없이, 평소 느끼시는 정도로 답해 주세요.", "전반적인 느낌"),
    c("fatigue", "지난 한 달 동안 피곤하다고 느끼신 적이 있습니까?",
      [["항상 그렇다", 4], ["거의 대부분 그렇다", 3], ["종종 그렇다", 2],
       ["가끔씩 그렇다", 1], ["전혀 그렇지 않다", 0]]),
    c("stair_diff", "쉬지 않고 계단 10개를 오르는 것이 힘드십니까?", HARD,
      "난간을 잡는 것은 괜찮습니다. 다른 사람의 도움 없이 기준입니다.", "이동 능력 점검"),
    c("walk_diff", "쉬지 않고 300m를 걷는 것이 힘드십니까?", HARD,
      "300m는 지하철 한 정거장의 절반쯤 되는 거리입니다.", "이동 능력 점검"),
    ...IADL_ITEMS.map(([code, title, levels]) =>
      c(code, `${title} — 도움 없이 혼자 하실 수 있습니까?`,
  ...
  { name: "질환 · 마음", count: 6, lead: "진단받은 질환과 마음 상태를 여쭤봅니다", cards: [
    { code: "diseases", type: "multi",
      title: "의사에게 진단받아 앓고 계신 질환을 모두 골라 주세요.",
